"""
Django settings for oleh_bali project.
...
SECRET_KEY = 'django-insecure-*0n71a(2_o2+h)wm)ma+%k%x0%3+bq=2ayrezuko^k0hyr*enr'
...
WSGI_APPLICATION = 'oleh_bali.wsgi.application'
